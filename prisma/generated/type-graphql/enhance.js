...
const modelsInfo = {
    ...
    File: ["id", "file", "taskId"],
    Task: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid", "workspaceId"],
...
const outputsInfo = {
    ...
    TaskGroupBy: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid", "workspaceId", "_count", "_avg", "_sum", "_min", "_max"],
    AggregateStatus: ["_count", "_avg", "_sum", "_min", "_max"],
    StatusGroupBy: ["id", "name", "color", "type", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    TaskCount: ["files"],
    TaskCountAggregate: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid", "workspaceId", "_all"],
    TaskAvgAggregate: ["statusid"],
    TaskSumAggregate: ["statusid"],
    TaskMinAggregate: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid", "workspaceId"],
    TaskMaxAggregate: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid", "workspaceId"],
    StatusCount: ["task"],
    StatusCountAggregate: ["id", "name", "color", "type", "_all"],
    StatusAvgAggregate: ["id"],
    StatusSumAggregate: ["id"],
    StatusMinAggregate: ["id", "name", "color", "type"],
    StatusMaxAggregate: ["id", "name", "color", "type"],
    ...
    CreateManyAndReturnTask: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid", "workspaceId", "status", "workspace"],
    CreateManyAndReturnStatus: ["id", "name", "color", "type"]
};
...
const inputsInfo = {
    ...
    TaskWhereInput: ["AND", "OR", "NOT", "id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid", "workspaceId", "status", "files", "workspace"],
    TaskOrderByWithRelationInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid", "workspaceId", "status", "files", "workspace"],
    TaskWhereUniqueInput: ["id", "AND", "OR", "NOT", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid", "workspaceId", "status", "files", "workspace"],
    TaskOrderByWithAggregationInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid", "workspaceId", "_count", "_avg", "_max", "_min", "_sum"],
    TaskScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid", "workspaceId"],
    StatusWhereInput: ["AND", "OR", "NOT", "id", "name", "color", "type", "task"],
    StatusOrderByWithRelationInput: ["id", "name", "color", "type", "task"],
    StatusWhereUniqueInput: ["id", "name", "AND", "OR", "NOT", "color", "type", "task"],
    StatusOrderByWithAggregationInput: ["id", "name", "color", "type", "_count", "_avg", "_max", "_min", "_sum"],
    StatusScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "color", "type"],
    ...
    TaskCreateInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "status", "files", "workspace"],
    TaskUpdateInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "status", "files", "workspace"],
    TaskCreateManyInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid", "workspaceId"],
    TaskUpdateManyMutationInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt"],
    StatusCreateInput: ["name", "color", "type", "task"],
    StatusUpdateInput: ["name", "color", "type", "task"],
    StatusCreateManyInput: ["id", "name", "color", "type"],
    ...
    TaskCountOrderByAggregateInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid", "workspaceId"],
    TaskAvgOrderByAggregateInput: ["statusid"],
    TaskMaxOrderByAggregateInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid", "workspaceId"],
    TaskMinOrderByAggregateInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid", "workspaceId"],
    TaskSumOrderByAggregateInput: ["statusid"],
    EnumStatusTypeFilter: ["equals", "in", "notIn", "not"],
    StatusCountOrderByAggregateInput: ["id", "name", "color", "type"],
    StatusAvgOrderByAggregateInput: ["id"],
    StatusMaxOrderByAggregateInput: ["id", "name", "color", "type"],
    StatusMinOrderByAggregateInput: ["id", "name", "color", "type"],
    ...
    TaskCreateWithoutWorkspaceInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "status", "files"],
    ...
    TaskScalarWhereInput: ["AND", "OR", "NOT", "id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid", "workspaceId"],
    ...
    TaskCreateWithoutFilesInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "status", "workspace"],
    ...
    TaskUpdateWithoutFilesInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "status", "workspace"],
    StatusCreateWithoutTaskInput: ["name", "color", "type"],
    ...
    StatusUpdateWithoutTaskInput: ["name", "color", "type"],
    ...
    TaskCreateWithoutStatusInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "files", "workspace"],
    ...
    TaskCreateManyWorkspaceInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusid"],
    TaskUpdateWithoutWorkspaceInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "status", "files"],
    FileCreateManyTaskInput: ["id", "file"],
    FileUpdateWithoutTaskInput: ["file"],
    TaskCreateManyStatusInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "workspaceId"],
    TaskUpdateWithoutStatusInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "files", "workspace"]
};

...
const outputsInfo = {
    ...
    TaskGroupBy: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusId", "priorityId", "workspaceId", "_count", "_min", "_max"],
    AggregateStatus: ["_count", "_min", "_max"],
    StatusGroupBy: ["id", "name", "color", "type", "userId", "_count", "_min", "_max"],
...
const inputsInfo = {
    ...
    TaskOrderByWithAggregationInput: ["id", "name", "message", "note", "dueDate", "createdAt", "updatedAt", "statusId", "priorityId", "workspaceId", "_count", "_max", "_min"],
    ...
    StatusOrderByWithAggregationInput: ["id", "name", "color", "type", "userId", "_count", "_max", "_min"],
    ...
    StatusCreateInput: ["id", "name", "color", "type", "user", "priorityTasks", "statusTasks"],
    StatusUpdateInput: ["id", "name", "color", "type", "user", "priorityTasks", "statusTasks"],
    StatusCreateManyInput: ["id", "name", "color", "type", "userId"],
    StatusUpdateManyMutationInput: ["id", "name", "color", "type"],
    ...
    StatusCreateWithoutUserInput: ["id", "name", "color", "type", "priorityTasks", "statusTasks"],
    ...
    StatusCreateWithoutStatusTasksInput: ["id", "name", "color", "type", "user", "priorityTasks"],
    StatusCreateOrConnectWithoutStatusTasksInput: ["where", "create"],
    StatusCreateWithoutPriorityTasksInput: ["id", "name", "color", "type", "user", "statusTasks"],
    ...
    StatusUpdateWithoutStatusTasksInput: ["id", "name", "color", "type", "user", "priorityTasks"],
    StatusUpsertWithoutPriorityTasksInput: ["update", "create", "where"],
    StatusUpdateToOneWithWhereWithoutPriorityTasksInput: ["where", "data"],
    StatusUpdateWithoutPriorityTasksInput: ["id", "name", "color", "type", "user", "statusTasks"],
    ...
    StatusUpdateWithoutUserInput: ["id", "name", "color", "type", "priorityTasks", "statusTasks"],
